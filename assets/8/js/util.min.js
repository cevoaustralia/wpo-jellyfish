...
return i}var l,i=t(this),r=t("body"),n=t(window),o=i.attr("id")
return l=t.extend({delay:0,hideOnClick:!1,hideOnEscape:!1,hideOnSwipe:!1,resetScroll:!1,resetForms:!1,side:null,target:i,visibleClass:"visible"},e),"Zepto"!=typeof l.target&&(l.target=t(l.target)),i._hide=function(t){l.target.hasClass(l.visibleClass)&&(t&&(t.preventDefault(),t.stopPropagation()),l.target.removeClass(l.visibleClass),window.setTimeout(function(){l.resetScroll&&i.scrollTop(0),l.resetForms&&i.find("form").each(function(){this.reset()})},l.delay))},i.css("-ms-overflow-style","-ms-autohiding-scrollbar").css("-webkit-overflow-scrolling","touch"),l.hideOnClick&&(i.find("a").css("-webkit-tap-highlight-color","rgba(0,0,0,0)"),i.on("click","a",function(e){var a=t(this),r=a.attr("href"),n=a.attr("target")
r&&"#"!=r&&""!=r&&r!="#"+o&&(e.preventDefault(),e.stopPropagation(),i._hide(),window.setTimeout(function(){"_blank"==n?window.open(r):window.location.href=r},l.delay+10))})),i.on("touchstart",function(t){}),i.on("touchmove",function(t){if(null!==i.touchPosX&&null!==i.touchPosY){var e=i.touchPosX-t.originalEvent.touches[0].pageX,a=i.touchPosY-t.originalEvent.touches[0].pageY,r=i.outerHeight(),n=i.get(0).scrollHeight-i.scrollTop()
if(l.hideOnSwipe){var o=!1
switch(l.side){case"left":o=a<20&&a>-20&&e>50
break
case"right":o=a<20&&a>-20&&e<-50
break
case"top":o=e<20&&e>-20&&a>50
break
...
"Zepto"!=typeof e&&(e=t(e)),e.each(function(){var e,i=t(this),r=i.parent()
...
i.prependTo(r),i.data(l,e)}})}}(Zepto)
