...
return i}var l,i=t(this),o=t("body"),n=t(window),r=i.attr("id")
return l=t.extend({delay:0,hideOnClick:!1,hideOnEscape:!1,hideOnSwipe:!1,resetScroll:!1,resetForms:!1,side:null,target:i,visibleClass:"visible"},e),"Zepto"!=typeof l.target&&(l.target=t(l.target)),i._hide=function(t){l.target.hasClass(l.visibleClass)&&(t&&(t.preventDefault(),t.stopPropagation()),l.target.removeClass(l.visibleClass),window.setTimeout(function(){l.resetScroll&&i.scrollTop(0),l.resetForms&&i.find("form").each(function(){this.reset()})},l.delay))},i.css("-ms-overflow-style","-ms-autohiding-scrollbar").css("-webkit-overflow-scrolling","touch"),l.hideOnClick&&(i.find("a").css("-webkit-tap-highlight-color","rgba(0,0,0,0)"),i.on("click","a",function(e){var a=t(this),o=a.attr("href"),n=a.attr("target")
o&&"#"!=o&&""!=o&&o!="#"+r&&(e.preventDefault(),e.stopPropagation(),i._hide(),window.setTimeout(function(){"_blank"==n?window.open(o):window.location.href=o},l.delay+10))})),i.on("touchstart",function(t){i.touchPosX=t.originalEvent.touches[0].pageX,i.touchPosY=t.originalEvent.touches[0].pageY}),i.on("touchmove",function(t){if(null!==i.touchPosX&&null!==i.touchPosY){var e=i.touchPosX-t.originalEvent.touches[0].pageX,a=i.touchPosY-t.originalEvent.touches[0].pageY,o=i.outerHeight(),n=i.get(0).scrollHeight-i.scrollTop()
if(l.hideOnSwipe){var r=!1
switch(l.side){case"left":r=a<20&&a>-20&&e>50
break
case"right":r=a<20&&a>-20&&e<-50
break
case"top":r=e<20&&e>-20&&a>50
break
case"bottom":r=e<20&&e>-20&&a<-50}if(r)return i.touchPosX=null,i.touchPosY=null,i._hide(),!1}(i.scrollTop()<0&&a<0||n>o-2&&n<o+2&&a>0)&&(t.preventDefault(),t.stopPropagation())}}),i.on("click touchend touchstart touchmove",function(t){t.stopPropagation()}),i.on("click",'a[href="#'+r+'"]',function(t){t.preventDefault(),t.stopPropagation(),l.target.removeClass(l.visibleClass)}),o.on("click touchend",function(t){i._hide(t)}),o.on("click",'a[href="#'+r+'"]',function(t){t.preventDefault(),t.stopPropagation(),l.target.toggleClass(l.visibleClass)}),l.hideOnEscape&&n.on("keydown",function(t){27==t.keyCode&&i._hide(t)}),i},t.fn.placeholder=function(){if(void 0!==document.createElement("input").placeholder)return t(this)
...
"Zepto"!=typeof e&&(e=t(e)),e.each(function(){var e,i=t(this),o=i.parent()
if(0!=o.length)if(i.data(l)){if(a)return
e=i.data(l),i.insertAfter(e),i.removeData(l)}else{if(!a)return
if(e=i.prev(),0==e.length)return
i.prependTo(o),i.data(l,e)}})}}(Zepto)
