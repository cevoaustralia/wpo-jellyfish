...
var a,u,h,c,p
switch(a=i++,u=jQuery.extend({top:0,bottom:0,delay:0,mode:"default",enter:null,leave:null,initialize:null,terminate:null,scroll:null},l),u.mode){case"top":h=function(t,e,n,i,o){return t>=i&&t<=o}
break
case"bottom":h=function(t,e,n,i,o){return n>=i&&n<=o}
break
case"middle":h=function(t,e,n,i,o){return e>=i&&e<=o}
break
case"top-only":h=function(t,e,n,i,o){return t<=i&&i<=n}
break
case"bottom-only":h=function(t,e,n,i,o){return n>=o&&o>=t}
break
default:case"default":h=function(t,e,n,i,o){return n>=i&&t<=o}}return c=function(t){var i,o,l,s,r,a,u=this.state,h=!1,c=this.$element.offset()
